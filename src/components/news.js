...
class News extends Component {
    ...
    return this.state.allnews.map((e, idx) => {
      ...
      if (idx % 2 === 0)
        return (
          ...
          >
            <td className="tdnews source">{e[0]}</td>
            <td className="tdnews">{e[1]}</td>
            <td className="tdnewss dt">{dt}</td>
          </tr>
        );
      else
        return (
  ...
  renderNewsDetails() {
    ...
    if (this.state.allnews[0] !== undefined) {
      ...
      category =
        category.toUpperCase().substring(0, 1) +
      ...
      <>
        <article>
          <figure>
            ...
            <figcaption>
              Source: {src} <br></br> Category: {category}
            </figcaption>
          </figure>
          <hgroup>
            <h2>{hl}</h2>
  ...
  render() {
    return (
      <div className={this.blur}>
                ...
                <td>
                  ...
                  <div>
                    <table className="headTbl tablenews">
                      <thead>
                        <tr className="trnews">
                          <th className="thnews hsource">Source</th>
                          <th className="thnews headline">Headline</th>
                          <th className="thnews hdate">Date/Time</th>
                        </tr>
                      </thead>
                    </table>
        ...
        <aside className="view">{this.renderNewsDetails()}</aside>
      </div>
    );
  }
}
